...
class EventReader:
    ...
    def __init__(
        self, directories: list[WatchedDirectory], *, max_open_files: int = 128
    ):
    ...
    def _on_file_created(self, path: Path) -> None:
        ...
        # Initialize tail position to 0 if not already tracked
        watch = self._find_watcher(path)
    ...
    def start_watching(
        ...
        # Create DirectoryWatch for each directory via FileWatcherService
